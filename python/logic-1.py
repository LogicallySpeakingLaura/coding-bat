...
def caught_speeding(speed, is_birthday):
    ...
    if is_birthday:
        if 66 <= speed <= 85:
            ticket = 1
        elif speed > 85: # could do >= 86 if that logic is easier to understand
            ticket = 2
    else:
        if 61 <= speed <= 80:
            ticket = 1
...
def sorta_sum(a, b):
    ...
    """
    return 20 if 10 <= a + b < 20 else a + b # could do <= 19 if that logic is easier to understand
...
def alarm_clock(day, vacation):
    ...
    if vacation and (day == 0 or day == 6): # is it a vacation and a weekend day
        alarm = 'off'
    elif not vacation and not (day == 0 or day == 6): # is it a weekday and no vacation
        alarm = '7:00'
