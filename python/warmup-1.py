...
def missing_char(str, n):
    ...
    """
    return str[: n] + str[
                      n + 1:]  # first string is up to n not inclusive, second is one letter after n to length of string


def front_back(str):
    """
    Given a string, return a new string where the first and last chars have been exchanged.
    """   # check for length first, otherwise last + middle + first
...
def front3(str):
    ...
    """ # check for length before splitting and building string
