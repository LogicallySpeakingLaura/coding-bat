...
def hello_name(name):
    ...
    """
    return "Hello " + name + "!" # concat all the pieces together in order
...
def make_tags( tag, word ):
    ...
    """
    return "<" + tag + ">" + word + "</" + tag + ">" # concat all the pieces together in order
...
def combo_string( a, b ):
    ...
    """
    return a + b + a if len(a) < len(b) else b + a + b # concat in order after checking length
